...
_HTML_TAG_NAMES = [
    ...
    "Ol", "Optgroup", "Option", "Output", "P", "Picture", "PortalExperimental", "Pre",
...
# fmt: off
_SVG_TAG_NAMES = [
    "Svg", "G", "Rect", "Circle", "Ellipse", "Line", "Polyline", "Polygon", "Text",
    "SvgPath", "AltGlyph", "AltGlyphDef", "AltGlyphItem", "Animate", "AnimateColor",
    "AnimateMotion", "AnimateTransform", "ClipPath", "Color_profile", "Cursor", "Defs",
    "Desc", "FeBlend", "FeColorMatrix", "FeComponentTransfer", "FeComposite",
    ...
    "Font_face", "Font_face_format", "Font_face_name", "Font_face_src", "Font_face_uri",
    "ForeignObject", "Glyph", "GlyphRef", "Hkern", "Image", "LinearGradient", "Marker",
    "Mask", "Metadata", "Missing_glyph", "Mpath", "Pattern", "RadialGradient", "Set",
    "Stop", "Switch", "Symbol", "TextPath", "Tref", "Tspan", "Use", "View", "Vkern",
]
# fmt: on
