                ...
                Div(
                    ...
                    Div(
                        ...
                        Div(
                                ...
                                Div(
                                    ...
                                    Div(
                                        Div(
                                            Span(
                                                "Preview",
                                                cls="border-b-2 border-primary px-4 pb-3 pt-2 font-semibold text-primary",
                                            ),
                            ...
                            H2(
                                "Examples",
                                cls="mt-16 scroll-m-20 border-b pb-4 text-xl font-semibold tracking-tight first:mt-0",
                            ),
                            # Default variant
                                    ...
                                    Div(
                                        Div(
                                            ...
                                            Div(
                                                Div(
                                                    Button(
                                                        "Click count: ", Span(ds_text="$count"), ds_on_click="$count++"
                                                    ),
                                                    ds_signals={"count": 0},
                                                ),
                                                cls="preview flex min-h-[350px] w-full justify-center p-10 items-center",
