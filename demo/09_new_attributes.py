...
def home():
    return Div(
        ...
        Div(
            ...
            Div(
                P("Loading...", ds_text="$loadMessage", ds_on_load="$loadMessage = 'Component loaded at ' + new Date().toLocaleTimeString()"),
                cls="border p-4 bg-blue-50 rounded"
            ),
            P("With __once modifier (only loads once):", cls="mb-2 mt-4"),
            Div(
                P("Loading...", ds_text="$onceMessage", ds_on_load__once="$onceMessage = 'Loaded once at ' + new Date().toLocaleTimeString()"),
        ...
        Div(
            ...
            Button("Update page (form values preserved)",
        ...
        Div(
            ...
            Pre(
                ds_json_signals=True,
                cls="bg-gray-900 text-green-400 p-4 rounded font-mono text-sm overflow-auto"
            ),
