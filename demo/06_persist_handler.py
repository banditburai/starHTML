...
def render_todo_list(todos):
    ...
    return Div(
        P("Todo Items:", cls="font-semibold mb-2"),
        *todo_items,
        id="todo-list"
    )
...
def home():
    return Div(
        ...
        Header(
            ...
            P("Demonstrating automatic signal persistence with localStorage and sessionStorage", cls="text-muted-foreground"),
        ...
        Main(
            ...
            Section(
                ...
                P("Values automatically saved to localStorage and restored on page load:", cls="mb-4 text-muted-foreground"),
            ...
            Section(
                ...
                P("Counter persists across page reloads, but reset clears both display and storage:", cls="mb-4 text-muted-foreground"),
            ...
            Section(
                ...
                P("Add items to the list - they'll persist server-side using Datastar SSE:", cls="mb-4 text-muted-foreground"),
            ...
            Section(
                ...
                P("This data is only saved for this browser tab and cleared when the tab closes:", cls="mb-4 text-muted-foreground"),
            ...
            Section(
                ...
                P("Toggle between light and dark themes - your preference is remembered:", cls="mb-4 text-muted-foreground"),
            ...
            Section(
                ...
                Div(
                    ...
                    Div(
                        ...
                        P("This counter will reset on every page reload (persistence disabled).", cls="text-sm text-gray-500 mb-3"),
                        Button(
                ...
                Div(
                    ...
                    Div(
                        ...
                        P("These values use a custom storage key: 'starhtml-persist-myapp'", cls="text-sm text-gray-500 mb-3"),
                        Button(
                            "Update Version",
                ...
                Div(
                    ...
                    Div(
                        ...
                        P("Only tabId persists in this tab session. Page views reset every reload.", cls="text-sm text-gray-500 mb-3"),
                        Button(
                            "New Tab ID",
            ...
            Section(
                ...
                P("The persist handler uses a two-phase approach for optimal performance:", cls="mb-4 text-muted-foreground"),
        ...
        # Footer
        Footer(
            P("Persist Handler Demo - Powered by StarHTML Signal Persistence", cls="text-center text-sm text-muted-foreground py-8"),
            cls="border-t"
        ),
