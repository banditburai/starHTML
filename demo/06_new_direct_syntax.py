...
def home():
    ...
    return Div(
        ...
        Div(
            ...
            Form(
                Input(type="text", ds_bind="$username", placeholder="Enter username", cls="border p-2 rounded"),
                P("Hello, ", ds_text="$username || 'Guest'", cls="mt-2"),
                cls="space-y-2 mb-8",
            ),
        ),
        ...
        Div(
            ...
            Div("This content is conditionally visible!", ds_show="$showContent", cls="p-4 bg-yellow-100 rounded"),
            cls="mb-8",
        ),
        ...
        Div(
            ...
            Div("Loading...", ds_show="$loading", cls="mt-2 text-gray-600"),
            Div(id="sse-content", cls="mt-4 p-4 bg-gray-100 rounded min-h-[50px]"),
            cls="mb-8",
        ),
        # Initialize all signals
        ds_signals={"username": "", "clickCount": 0, "showContent": False, "isLoading": False, "loading": False},
