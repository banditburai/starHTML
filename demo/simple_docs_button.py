        ...
        Div(
            ...
            Div(
                ...
                Div(
                    Div(
                        Button("Button"),
                        cls="flex min-h-[350px] items-center justify-center p-6"
                    ),
            ...
            # Installation
            Div(
                H2("Installation", cls="font-heading mt-12 scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight"),
                Div(
                    Pre(
            ...
            # Examples
            Div(
                H2("Examples", cls="font-heading mt-12 scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight"),
