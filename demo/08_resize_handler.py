    ...
    return Div(
        ...
        Main(
            ...
            Section(
                ...
                P("This container changes its layout based on its own width (container queries simulation):", cls="mb-4 text-muted-foreground"),
            ...
            Section(
                ...
                Div(
                    ...
                    Div(
                        ...
                        P("Element vs Window: ", Span(ds_text="$sizeRatio"), "% of window width", cls="text-sm font-medium"),
                        cls="space-y-2"
                    ),
        ...
        # Footer
        Footer(
            P("Resize Handler Demo - Powered by StarHTML ResizeObserver", cls="text-center text-sm text-muted-foreground py-4"),
            cls="border-t"
        ),
...
def add_box(req):
    ...
    yield elements(
        Div(
            ...
            P("Size: ", Span(ds_text=f"$dynamicWidth{box_id}"), "x", Span(ds_text=f"$dynamicHeight{box_id}"), "px", cls="text-sm"),
