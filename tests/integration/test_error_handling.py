    ...
    def test_connection_error_simulation(self):
        ...
        def external_api():
            ...
            try:
                ...
                return JSONResponse(
                    {"error": "External service unavailable", "details": str(e)},
                    status_code=503
                )
...
class TestResourceExhaustion:
    ...
    def test_large_data_processing(self):
        ...
        def process_data(size: int):
            ...
            if size > max_safe_size:
                return JSONResponse(
                    {"error": "Data size exceeds limit", "max_size": max_safe_size},
                    status_code=413
                )
    ...
    def test_concurrent_request_handling(self):
        ...
        def concurrent_endpoint():
            ...
            request_counter["max_concurrent"] = max(
                request_counter["max_concurrent"],
                request_counter["active"]
            )
        ...
        def file_operations_endpoint():
            try:
                ...
                return {
                    ...
                    "file_descriptors": {
                        "opened": file_operations["opened"],
                        "closed": file_operations["closed"]
                    }
                }
            except Exception as e:
                file_operations["errors"].append(str(e))
                return JSONResponse(
                    {"error": "File operation failed", "details": str(e)},
                    status_code=500
                )
...
class TestExceptionPropagation:
    ...
    def test_custom_exception_handler(self):
        ...
        async def custom_error_handler(request, exc):
            return JSONResponse(
                {"error": "Custom error occurred", "message": str(exc)},
                status_code=400
            )
    ...
    def test_nested_exception_handling(self):
        ...
        def nested_error():
            try:
                ...
                return JSONResponse(
                    {"error": "Nested error", "details": str(e)},
                    status_code=500
                )
    ...
    def test_resource_cleanup_on_error(self):
        ...
        def resource_error():
            try:
                ...
                return JSONResponse(
                    {"error": str(e), "resources_cleaned": resource_counter["active"] == 0},
                    status_code=500
                )
