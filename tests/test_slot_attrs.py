...
from starhtml.tags import Div, Label, Span, Button, Input, Form
from starhtml.datastar import toggle_class, ds_show, ds_class, ds_bind, DatastarAttr, slot_attrs
...
class TestSlotAttrsBasic:
    ...
    def test_single_slot_with_toggle_class(self):
        ...
        element = Div(
            Label("Task", data_slot="label"),
            slot_attrs={"label": toggle_class("done", "line-through", "")}
        )
    ...
    def test_multiple_slots_different_attrs(self):
        ...
        element = Div(
            ...
            slot_attrs={
                "label": toggle_class("active", "font-bold", ""),
                "content": ds_show("$visible")
            }
        )
...
class TestSlotAttrsEdgeCases:
    ...
    def test_direct_attrs_take_precedence(self):
        ...
        element = Div(
            Label(
                "Text",
                data_slot="label",
                **toggle_class("local", "text-red", "text-blue").attrs
            ),
    ...
    def test_nonexistent_slot_ignored(self):
        ...
        element = Div(
            ...
            slot_attrs={
                "label": toggle_class("active", "bold", ""),
                "nonexistent": ds_show("$never")
            }
        )
    ...
    def test_slot_attrs_not_in_output(self):
        ...
        element = Div(
            Label("Text", data_slot="label"),
            slot_attrs={"label": ds_show("$visible")}
        )
...
class TestSlotAttrsWithDatastar:
    ...
    def test_with_ds_show(self):
        ...
        element = Div(
            Span("Hidden", data_slot="content"),
            slot_attrs={"content": ds_show("$isVisible")}
        )
    ...
    def test_with_ds_bind(self):
        ...
        element = Form(
            ...
            slot_attrs={"input": ds_bind("username")}
        )
    ...
    def test_with_custom_datastar_attr(self):
        ...
        element = Div(
            Span("Text", data_slot="span"),
            slot_attrs={"span": custom_attr}
        )
...
class TestSlotAttrsRealWorldScenarios:
    ...
    def test_checkbox_with_label_component(self):
        ...
        component = CheckboxWithLabel(
            ...
            signal="task1",
            slot_attrs={
                "label": toggle_class("task1", "line-through text-gray-500", ""),
                "checkbox": ds_bind("task1")
            }
        )
    ...
    def test_dropdown_component(self):
        ...
        dropdown = Dropdown(
            ...
            slot_attrs={
                "trigger": toggle_class("open", "rotate-180", ""),
                "content": ds_show("$open")
            }
        )
    ...
    def test_form_with_multiple_inputs(self):
        ...
        form = Form(
            ...
            slot_attrs={
                ...
                "submit": [
                    toggle_class("loading", "opacity-50 cursor-wait", ""),
                    ds_show("$formValid")
                ]
            }
        )
...
class TestSlotAttrsWithDictAttributes:
    ...
    def test_dict_attributes(self):
        ...
        element = Div(
            Span("Text", data_slot="span"),
            slot_attrs={
                "span": {"data-test": "value", "id": "my-span"}
            }
        )
...
class TestSlotAttrsPositional:
    ...
    def test_positional_with_multiple_attrs_per_slot(self):
        ...
        element = Div(
            slot_attrs(
                button=[
                    toggle_class("loading", "opacity-50", ""),
                    ds_show("$enabled"),
                    ds_class(hover="bg-blue-600")
                ]
            ),
    ...
    def test_both_positional_and_kwarg_patterns(self):
        ...
        elem1 = Div(
            slot_attrs(label=ds_show("$visible")),
            Label("Positional", data_slot="label")
        )
        
        # Kwarg pattern (original)
        elem2 = Div(
            Label("Kwarg", data_slot="label"),
            slot_attrs={"label": ds_show("$visible")}
        )
    ...
    def test_positional_in_component_function(self):
        ...
        component = FormField(
            "Username",
            "username",
            field_attrs=slot_attrs(
                input=ds_bind("username"),
                error=ds_show("$usernameError")
            )
        )
