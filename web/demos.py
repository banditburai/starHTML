...
DEMOS = [
    ...
    Demo(
        ...
        "24_advanced_toggle_patterns.py",
        "Patterns",
    ),
    Demo(
        "25-complex-modifiers",
        "Complex Modifiers",
        "Advanced modifier combinations and patterns",
        "25_complex_modifiers.py",
        "Patterns",
    ),
    Demo(
        "26-property-chaining",
        "Property Chaining",
        "Deep property access and manipulation",
        "26_nested_property_chaining.py",
        "Patterns",
    ),
    Demo(
        "27-datastar-helpers",
        ...
        "27_datastar_helpers_showcase.py",
        "Patterns",
    ),
]
