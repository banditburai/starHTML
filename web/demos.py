...
DEMOS = [
    ...
    Demo(
        "24-motion-svg",
        "Motion SVG Plugin",
        "Reactive SVG attribute animations with spring physics and path morphing",
        "24_motion_svg_plugin.py",
        "Advanced",
    ),
    Demo(
        "25-toggle-patterns",
        ...
        "25_advanced_toggle_patterns.py",
        "Patterns",
    ),
    Demo(
        "26-complex-modifiers",
        "Complex Modifiers",
        "Advanced modifier combinations and patterns",
        "26_complex_modifiers.py",
        "Patterns",
    ),
    Demo(
        "27-property-chaining",
        "Property Chaining",
        "Deep property access and manipulation",
        "27_nested_property_chaining.py",
        "Patterns",
    ),
    Demo(
        "28-datastar-helpers",
